-- =============================================================================
-- MIGRACIÓN: Módulo Dashboard - Nuevas Métricas Estadísticas (Pedidos Delivery y Productos Vendidos)
-- Propósito: Rediseñar la función RPC obtener_metricas_dashboard para retornar pedidos_delivery y productos_vendidos.
-- Idioma: Español
-- =============================================================================
